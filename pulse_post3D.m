...
%   cd(postpath)
[ STavg_entr,STavg_jentr,massratio] = emergency( run,time,...
...
% Save key output parameters to file
  ...
  keyParams = cell2table(keyParams,'VariableNames',{'Pulse','Frequency',...
        'MinEPG','MaxEPG','D_S1','D_S2','D_S3','StokesS1','StokesS2',...
        'StokesS3','AvgEPG','AvgMFR','AvgMFlux','AvgEntr','AvgJEntr',...
        'MassRatio'});
