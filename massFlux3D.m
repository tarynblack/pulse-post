function [ vidMassFlux ] = massFlux3D( dir,vis,viewaz,viewel,ghostcells,...
...
%   Last edit: Taryn Black, 18 February 2016
  ...
  % Clear directory of appending files from previous processing attempts
    cd(dir)
    delete('massflux*','netmassflux*','MFlux_*')
...
%         fID_VS3 = fopen(sprintf('V_S_t%02d.txt',t));
      ...
      % Save all calculated mass fluxes (incl. net) at each timestep
        ...
        dlmwrite(fullfile(sprintf('%s',dir),sprintf('net_massflux_%s.txt',...
